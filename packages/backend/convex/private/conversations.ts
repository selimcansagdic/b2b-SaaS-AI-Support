...
export const getMany = query({
  ...
  handler: async (ctx, args) => {
    ...
    const converstionsWithAdditionalData = await Promise.all(
    ...
    const validConversations = converstionsWithAdditionalData.filter((conv): conv is NonNullable<typeof conv> => conv !== null);
